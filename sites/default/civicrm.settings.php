...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:Filck2bup@localhost/test?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicrm:civicrm_mysql@localhost/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/Library/WebServer/Documents/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Library/WebServer/Documents/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '50a7e59f0261f7e1c6299303df266b46');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Library/WebServer/Documents/sites/default/files/civicrm/templates_c//mail.log');
// }
